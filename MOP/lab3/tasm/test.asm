;Дан массив из 10 байтов. Все байты имеют нулевые старшие биты.
;Необходимо каждый байт, содержащий 1 в 0-м бите, дополнить до четного
;числа единиц установкой 7-го бита байта, каждый байт, содержащий 0 в 0-м
;бите, дополнить до нечетного числа единиц установкой 7-го бита байта [14].  
