...
## Проведённые тесты:
1. Что такое тестирование ПО и для чего оно нужно?
    ```
    Тестирвоание ПО нужно чтобы увеличить его качество, уменьшить количество багов и тд. Очевидный профит
    ```
    
2. Какие области тестирования существуют?
    ```
    Их 3(4): Интеграционное, системное и модульное(приёмочное)
    ```

3. Какие типы тестов бывают?
    ```    
    Позитивные, негативные и исследовательские.
    ```
...
5. Каких тестов больше, негативных или позитивных, и почему?
    ```    
    Негативных, так как потенциальных нештатных ситуаций больше.
    ```

6. В чем заключается тестирование интерфейса и к какому виду тестирования оно относится?
    ```
    Вид функционального тестирования. Проверяем всё ли "тыкается", все ли надписи видно, все ли кнопки кликабельнгы и тд. 
    ```
